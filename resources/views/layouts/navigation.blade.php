        ...
        <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 space-x-8">
                    ...
                    <div x-data="{ openMenu: false }" class="relative">
                        <button @click="openMenu = !openMenu"
                            class="inline-flex items-center text-sm text-gray-600 hover:text-gray-800 px-3 py-2">
                            Menu
                        ...
                        <div x-show="openMenu" x-transition @click.outside="openMenu = false"
                            class="absolute mt-2 w-56 bg-white border border-gray-200 shadow-md rounded-md z-50 py-1">
                            ...
                            <a href="{{ route('admin.mentoring.index') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                Mentoring
                            </a>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex h-full items-center px-3 py-2 border border-transparent
